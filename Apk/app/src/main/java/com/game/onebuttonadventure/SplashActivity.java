...
public class SplashActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                VideoView videoTeste = (VideoView)findViewById(R.id.videoSplash);
                videoTeste.setVideoPath("android.resource://com.game.onebuttonadventure/raw/splashoficial");
                videoTeste.start();
            }
        },1000);
        ...
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                // CHAMANDO
                Intent intent = new Intent(SplashActivity.this, Headphones.class);
